...
public class Supplier implements Serializable {
	...
	private static final long serialVersionUID = 2286892225695191340L;
	...
	public String toString() {
		return "Supplier [supId=" + supId + ", supName=" + supName + ", supLinkman=" + supLinkman + ", supPhone="
				+ supPhone + ", supAddress=" + supAddress + ", supRemark=" + supRemark + ", supPay=" + supPay
				+ ", supType=" + supType + "]";
	}
